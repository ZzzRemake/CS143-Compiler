...
//#include "tree.h"
#include "/usr/class/include/PA4/tree.h"
#include "/usr/class/assignments/PA4/cool-tree.handcode.h"
...
public:
   ...
   virtual void AddMethod(Symbol class_name) = 0;
   virtual void AddAttribute(Symbol class_name) = 0;
   virtual void CheckExprType(Symbol class_name) = 0;
...
public:
   ...
   virtual Symbol CheckExprType(Symbol class_name) = 0;
...
public:
   ...
   Symbol GetParent() override { return parent; }
   Symbol GetFilename() override { return filename; }
...
public:
   ...
   void AddMethod(Symbol class_name) override;
   void AddAttribute(Symbol class_name) override;
   void CheckExprType(Symbol class_name) override;
...
public:
   ...
   Case copy_Case();
   void dump(ostream& stream, int n);
   Symbol CheckExprType(Symbol class_name) override;
   Symbol GetTypeDecl() override { return type_decl; };
